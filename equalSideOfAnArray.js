...
console.log(findEvenIndex([5, 1, 3, 3, 2, 1])); // 2
console.log(findEvenIndex([10, 5, 2, -3, 1, 5, 10])); // -1
console.log(findEvenIndex([1, 2, 3, 4, 5, 6, 7])); // -1
console.log(findEvenIndex([1, 1, 1, 1, 1, 1, 1, 1])); // 3
console.log(findEvenIndex([2, 3, 1, 2, 1])); // -1
console.log(findEvenIndex([0, 0, 0, 0, 0])); // 2
